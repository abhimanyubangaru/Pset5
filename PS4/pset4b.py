...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 15 10:35:41 2020
    ...
    def build_shift_dict(self, shift):
        ...
        for case in (upper_case_letters, lower_case_letters):
            for letter in case:
                ...
                # Simple shift if still within index boundaries
                if shift + ord(letter) <= last_index:
                    shifted_letter = chr(shift + ord(letter))
                
                # Loop around if simple shift exceed boundaries
                else:
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        return cipher_scan_results.get(max(cipher_scan_results)) #delete this line and replace with your code here
